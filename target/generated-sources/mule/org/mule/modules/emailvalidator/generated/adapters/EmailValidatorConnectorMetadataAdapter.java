...
/**
 * A <code>EmailValidatorConnectorMetadataAdapter</code> is a wrapper around {@link EmailValidatorConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-20T12:32:02-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class EmailValidatorConnectorMetadataAdapter
    extends EmailValidatorConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "EmailValidator";
