...
public class ValidateEmailIdMessageProcessorDebuggable
    extends ValidateEmailIdMessageProcessor
    implements DebugInfoProvider
{


    public ValidateEmailIdMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("emailId", "Email id", (java.lang.String.class), emailId, muleEvent));
